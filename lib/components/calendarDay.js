...
var CalendarDay = /** @class */ (function (_super) {
    ...
    CalendarDay.prototype.render = function () {
        var _a = this.props, index = _a.index, date = _a.date, renderEvent = _a.renderEvent, events = _a.events, textStyles = _a.textStyles, onPress = _a.onPress;
        ...
        return (react_1.default.createElement(react_native_1.View, { key: date.getTime(), style: cellStyles },
            react_1.default.createElement(react_native_1.TouchableOpacity, { style: styles.touchableOpacity, onPress: function () { return onPress && onPress(date); } },
